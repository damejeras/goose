...
const file_v1_api_proto_rawDesc = "" +
	"\n" +
	"\fv1/api.proto\x12\x06api.v1\"%\n" +
	"\x0fSayHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\",\n" +
	"\x10SayHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2Q\n" +
	"\x0eGreeterService\x12?\n" +
	"\bSayHello\x12\x17.api.v1.SayHelloRequest\x1a\x18.api.v1.SayHelloResponse\"\x00B$Z\"github.com/damejeras/goose/api/v1b\x06proto3"
...
var file_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_v1_api_proto_depIdxs = []int32{
	0, // 0: api.v1.GreeterService.SayHello:input_type -> api.v1.SayHelloRequest
	1, // 1: api.v1.GreeterService.SayHello:output_type -> api.v1.SayHelloResponse
